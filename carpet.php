<?php include 'includes/head.php'; ?>
    <body>
        ...
        ?>        
        <div class="container">
            <h1 class="pg_hdr">Carpet</h1>  <!-- Carpet Header -->
            <h4>Benefits Of Fitted Wardrobes</h4>   <!-- Carpet sub Header -->
            <p>One of the major benefits of bespoke fitted wardrobes over freestanding wardrobes, is the use of maximising space. You pick out the design, and we will do the rest.</p> <!-- carpet text -->
